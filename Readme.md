...
<table>
  ...
  <tr>
    <td><img width="268" height="480" src="/Image/result_image_ios_01.gif"></img></td>
  	<td><img width="270" height="480" src="/Image/result_image_and_01.gif"></img></td>
  </tr>
</table>
...
<br />
action이 **어떻게 (How) 변경**시켜야 하는 지는 **`reducer`**(들)가 정의합니다.<br />
<br />
